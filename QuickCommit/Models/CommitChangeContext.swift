nonisolated struct CommitChangeContext: Equatable, Sendable {
    ...
    init(changedFileCount: Int, modifiedFileCount: Int, untrackedFileCount: Int, deletedFileCount: Int, hasConflicts: Bool, paths: [String], stagedFileCount: Int = 0, unstagedFileCount: Int = 0, renamedFileCount: Int = 0, typeChangedFileCount: Int = 0, repositoryOperation: RepositoryOperationState = .idle) {
        self.changedFileCount = changedFileCount; self.stagedFileCount = stagedFileCount; self.unstagedFileCount = unstagedFileCount; self.modifiedFileCount = modifiedFileCount; self.untrackedFileCount = untrackedFileCount; self.deletedFileCount = deletedFileCount; self.renamedFileCount = renamedFileCount; self.typeChangedFileCount = typeChangedFileCount; self.hasConflicts = hasConflicts; self.repositoryOperation = repositoryOperation; self.paths = paths
    }
